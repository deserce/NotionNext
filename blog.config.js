...
const BLOG = {
      ...
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://not.liyy.us.kg', // 网站地址
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '无中生有为隐性, 隐性遗传看女病,父子皆病为伴性',

      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mcy070329@qq.com', // 邮箱地址 例如mail@tangly1024.com
      CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
      CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/mingcy070329', // 你的twitter个人主页
      ...
      MUSIC_PLAYER_AUDIO_LIST: [
          ...
          },
            {
                  ...
                  cover:
                        'https://p1.music.126.net/q-3t36CBjYBIByW_GtlKdA==/109951169172482310.jpg'
          },
            {
                  name: 'His Theme',
                  artist: 'Toby Fox',
            ...
            },
            {
                  name: '悬溺',
                  artist: '葛东琪',
                  url: 'https://music.163.com/song/media/outer/url?id=2071935674.mp3',
                  cover:
                        'https://p1.music.126.net/MIWMnBEedpJ8IpOau5D7PA==/109951168829804653.jpg'
            },
            {
                  name: '我属于你的注定',
                  artist: 'Zy',
                  url: 'https://music.163.com/song/media/outer/url?id=2122700931.MP3',
                  cover:
            ...
            },
            {
                  name: '罗生门(Follow)',
                  artist: '梨冻紧',
                  url: 'http://music.163.com/song/media/outer/url?id=1456890009.mp3',
                  cover:
